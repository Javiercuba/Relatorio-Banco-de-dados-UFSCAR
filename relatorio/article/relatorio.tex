...
outros tipos de usuários além do Pesquisador.

Possuindo uma tabela de hierarquia Usuario e
uma tabela por identidade especializada no caso 
é o Pesquisador.

Já as memórias e os relatórios são entidades fracas pois são
geradas a partir do trabalho de um ou mais Pesquisadores.

Cada Pesquisador pertence a uma ou mais Linhas de Pesquisa,
portanto, a partir desse relacionamento podemos aferir se
tal Pesquisador é o Líder de Pesquisa da Linha e se essa
Linha é a principal do Pesquisador.
