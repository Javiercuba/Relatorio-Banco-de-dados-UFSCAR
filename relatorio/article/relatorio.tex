...
O cpf\_usuario é a chave primária da tabela usuario
e o nome\_usuario é a segunda chave, por isso a utilização
do NOT NULL. 
...
O cpf\_usuario é a chave estrangeira da tabela pesquisador.
\end{document}
