...
\begin{tabular}{|c|l|rc|} \hline
    Tipo-Entidade & \multicolumn{3}{|c|} {Atributos} { Atributos}{Atributos}    \\ \hline \hline
    
    Núcleos & \multicolumn{2}{|c|}{terça}\\ \hline \hline

    Pesquisador & \multicolumn{1}{|c|}{terça}\\ \hline
     & fev & mar & abr \\ \hline
     & jun & jul & ago \\ \hline
     & out & nov & dez \\ \hline \hline


    

    Linhas de Pesquisa & \multicolumn{2}{|c|}{terça}      \\ \hline
    
\end{tabular}

\begin{tabular}{|c|l|rc|} \hline
    Núcleos & \multicolumn{2}{|c|}{terça}\\ \hline   
\end{tabular}
